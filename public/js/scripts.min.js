         ...
         Berserk.attachBehaviors(a("body"), Berserk.settings),
             function() {
                 if (a("[data-brk-library]:not(.brk-library-rendered)").addClass("brk-library-rendered").each(function() {
                     ...
                     var e, t = "",
                         n = "";
                     for (r in brk_xmode && (n = 'class="brk-css-add" '), s.css) e = Berserk.settings.project_prefix && -1 === s.css[r].indexOf("//") ? Berserk.settings.project_prefix : "", console.log("CSS added: " + e + s.css[r]), t += "<link " + n + 'rel="stylesheet"  href="' + e + s.css[r] + '">';
                     var i = a('[id*="brk-custom-css-"]');
                     i.length ? i.before(t) : a("head").append(t)
                 }
                 if (Object.keys(s.js).length) {
                     var o = 0;
                     for (r in s.js) e = Berserk.settings.project_prefix && -1 === s.js[r].indexOf("//") ? Berserk.settings.project_prefix : "", console.log("JS added: " + e + s.js[r]), a.cachedScript(e + s.js[r], {
