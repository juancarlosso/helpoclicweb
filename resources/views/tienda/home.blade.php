							...
							<div class="row">
									...
									<div class="flip-box text-center" data-brk-library="component__flip_box,component__elements,fancybox">
										<div class="flip flip_vertical flip-box__split">
											<div class="flip__front">
												<div class="flip-box__split-img lazyload" data-bg="{{asset('img/shop-1.jpg')}}"></div>
											...
											<div class="flip__back lazyload" data-bg=" {{asset('img/shop-1.jpg')}}">
												...
												<div class="flip-box__split-content">
													...
													<div class="flip-box__split-actions">
														...
														<a href="{{asset('img/shop-1.jpg')}}" class="add-search d-flex align-items-center justify-content-center fancybox">
								...
								<div class="col-12 col-md-6 col-xl-4">
									<div class="flip-box text-center" data-brk-library="component__flip_box,component__elements,fancybox">
										<div class="flip flip_vertical flip-box__split">
											<div class="flip__front">
												<div class="flip-box__split-img lazyload" data-bg="{{asset('img/shop-2.jpg')}}"></div>
												<div class="pt-30 pb-30 flip-box__split-info">
													<div class="font__family-montserrat font__weight-bold pl-20 pr-20 font__size-15">
														Some shop item
													</div>
											...
											<div class="flip__back lazyload" data-bg="{{asset('img/shop-2.jpg')}}">
												<div class="flip-box__split-overlay brk-base-bg-gradient-10deg"></div>
												<div class="flip-box__split-content">
													<div class="brk-sc-card-labels brk-sc-card-labels_side-labels">
														<div class="brk-sc-card-label">
													...
													<div class="flip-box__split-actions">
														...
														<a href="{{asset('img/shop-2.jpg')}}" class="add-search d-flex align-items-center justify-content-center fancybox">
															<i class="fas fa-search"></i>
														</a>
														<a href="#" class="add-wishlist d-flex align-items-center justify-content-center">
															<i class="fas fa-star"></i>
								...
								<div class="col-12 col-md-6 col-xl-4">
									<div class="flip-box text-center" data-brk-library="component__flip_box,component__elements,fancybox">
										<div class="flip flip_vertical flip-box__split">
											<div class="flip__front">
												<div class="flip-box__split-img lazyload" data-bg="{{asset('img/shop/shop-win-1.jpg')}}"></div>
												<div class="pt-30 pb-30 flip-box__split-info">
													<div class="font__family-montserrat font__weight-bold pl-20 pr-20 font__size-15">
														Some shop item
													</div>
											...
											<div class="flip__back lazyload" data-bg="{{asset('img/shop/shop-win-1.jpg')}}">
												<div class="flip-box__split-overlay brk-base-bg-gradient-10deg"></div>
												<div class="flip-box__split-content">
													<div class="brk-sc-card-labels brk-sc-card-labels_side-labels-cornered">
														<div class="brk-sc-card-label">
													...
													<div class="flip-box__split-actions">
														...
														<a href="{{asset('img/shop/shop-win-1.jpg')}}" class="add-search d-flex align-items-center justify-content-center fancybox">
															<i class="fas fa-search"></i>
														</a>
														<a href="#" class="add-wishlist d-flex align-items-center justify-content-center">
															<i class="fas fa-star"></i>
								...
								<div class="col-12 col-md-6 col-xl-4">
									<div class="flip-box text-center" data-brk-library="component__flip_box,component__elements,fancybox">
										<div class="flip flip_vertical flip-box__split">
											<div class="flip__front">
												<div class="flip-box__split-img lazyload" data-bg="{{asset('img/shop/shop-win-2.jpg')}}"></div>
												<div class="pt-30 pb-30 flip-box__split-info">
													<div class="font__family-montserrat font__weight-bold pl-20 pr-20 font__size-15">
														Some shop item
													</div>
											...
											<div class="flip__back lazyload" data-bg="{{asset('img/shop/shop-win-2.jpg')}}">
												<div class="flip-box__split-overlay brk-base-bg-gradient-10deg"></div>
												<div class="flip-box__split-content">
													<div class="brk-sc-card-labels brk-sc-card-labels_side-labels-cornered">
														<div class="brk-sc-card-label">
													...
													<div class="flip-box__split-actions">
														...
														<a href="{{asset('img/shop/shop-win-2.jpg')}}" class="add-search d-flex align-items-center justify-content-center fancybox">
															<i class="fas fa-search"></i>
														</a>
														<a href="#" class="add-wishlist d-flex align-items-center justify-content-center">
															<i class="fas fa-star"></i>
								...
								<div class="col-12 col-md-6 col-xl-4">
									<div class="flip-box text-center" data-brk-library="component__flip_box,component__elements,fancybox">
										<div class="flip flip_vertical flip-box__split">
											<div class="flip__front">
												<div class="flip-box__split-img lazyload" data-bg="{{asset('img/shop/shop-win-3.jpg')}}"></div>
												<div class="pt-30 pb-30 flip-box__split-info">
													<div class="font__family-montserrat font__weight-bold pl-20 pr-20 font__size-15">
														Some shop item
													</div>
											...
											<div class="flip__back lazyload" data-bg="{{asset('img/shop/shop-win-3.jpg')}}">
												<div class="flip-box__split-overlay brk-base-bg-gradient-10deg"></div>
												<div class="flip-box__split-content">
													<div class="pt-lg-30 pb-lg-30 pt-sm-20 pb-sm-20 pt-xs-40 pb-xs-40 pt-20 pb-20 position-relative z-index-5">
														<a href="#">
													...
													<div class="flip-box__split-actions">
														...
														<a href="{{asset('img/shop/shop-win-3.jpg')}}" class="add-search d-flex align-items-center justify-content-center fancybox">
															<i class="fas fa-search"></i>
														</a>
														<a href="#" class="add-wishlist d-flex align-items-center justify-content-center">
															<i class="fas fa-star"></i>
								...
								<div class="col-12 col-md-6 col-xl-4">
									<div class="flip-box text-center" data-brk-library="component__flip_box,component__elements,fancybox">
										<div class="flip flip_vertical flip-box__split">
											<div class="flip__front">
												<div class="flip-box__split-img lazyload" data-bg="{{asset('img/shop/shop-win-4.jpg')}}"></div>
												<div class="pt-30 pb-30 flip-box__split-info">
													<div class="font__family-montserrat font__weight-bold pl-20 pr-20 font__size-15">
														Some shop item
													</div>
											...
											<div class="flip__back lazyload" data-bg="{{asset('img/shop/shop-win-4.jpg')}}">
												<div class="flip-box__split-overlay brk-base-bg-gradient-10deg"></div>
												<div class="flip-box__split-content">
													<div class="pt-lg-30 pb-lg-30 pt-sm-20 pb-sm-20 pt-xs-40 pb-xs-40 pt-20 pb-20 position-relative z-index-5">
														<a href="#">
													...
													<div class="flip-box__split-actions">
														...
														<a href="{{asset('img/shop/shop-win-4.jpg')}}" class="add-search d-flex align-items-center justify-content-center fancybox">
															<i class="fas fa-search"></i>
														</a>
														<a href="#" class="add-wishlist d-flex align-items-center justify-content-center">
															<i class="fas fa-star"></i>
								...
								<div class="col-12 col-md-6 col-xl-4">
									<div class="flip-box text-center" data-brk-library="component__flip_box,component__elements,fancybox">
										<div class="flip flip_vertical flip-box__split">
											<div class="flip__front">
												<div class="flip-box__split-img lazyload" data-bg="{{asset('img/shop/shop-win-5.png')}}"></div>
												<div class="pt-30 pb-30 flip-box__split-info">
													<div class="font__family-montserrat font__weight-bold pl-20 pr-20 font__size-15">
														Some shop item
													</div>
											...
											<div class="flip__back lazyload" data-bg="{{asset('img/shop/shop-win-5.png')}}">
												<div class="flip-box__split-overlay brk-base-bg-gradient-10deg"></div>
												<div class="flip-box__split-content">
													<div class="pt-lg-30 pb-lg-30 pt-sm-20 pb-sm-20 pt-xs-40 pb-xs-40 pt-20 pb-20 position-relative z-index-5">
														<a href="#">
													...
													<div class="flip-box__split-actions">
														...
														<a href="{{asset('img/shop/shop-win-5.png')}}" class="add-search d-flex align-items-center justify-content-center fancybox">
															<i class="fas fa-search"></i>
														</a>
														<a href="#" class="add-wishlist d-flex align-items-center justify-content-center">
															<i class="fas fa-star"></i>
								...
								<div class="col-12 col-md-6 col-xl-4">
									<div class="flip-box text-center" data-brk-library="component__flip_box,component__elements,fancybox">
										<div class="flip flip_vertical flip-box__split">
											<div class="flip__front">
												<div class="flip-box__split-img lazyload" data-bg="{{asset('img/shop/shop-win-6.png')}}"></div>
												<div class="pt-30 pb-30 flip-box__split-info">
													<div class="font__family-montserrat font__weight-bold pl-20 pr-20 font__size-15">
														Some shop item
													</div>
											...
											<div class="flip__back lazyload" data-bg="{{asset('img/shop/shop-win-6.png')}}">
												<div class="flip-box__split-overlay brk-base-bg-gradient-10deg"></div>
												<div class="flip-box__split-content">
													<div class="pt-lg-30 pb-lg-30 pt-sm-20 pb-sm-20 pt-xs-40 pb-xs-40 pt-20 pb-20 position-relative z-index-5">
														<a href="#">
													...
													<div class="flip-box__split-actions">
														...
														<a href="{{asset('img/shop/shop-win-6.png')}}" class="add-search d-flex align-items-center justify-content-center fancybox">
															<i class="fas fa-search"></i>
														</a>
														<a href="#" class="add-wishlist d-flex align-items-center justify-content-center">
															<i class="fas fa-star"></i>
								...
								<div class="col-12 col-md-6 col-xl-4">
									<div class="flip-box text-center" data-brk-library="component__flip_box,component__elements,fancybox">
										<div class="flip flip_vertical flip-box__split">
											<div class="flip__front">
												<div class="flip-box__split-img lazyload" data-bg="{{asset('img/shop/shop-win-7.png')}}"></div>
												<div class="pt-30 pb-30 flip-box__split-info">
													<div class="font__family-montserrat font__weight-bold pl-20 pr-20 font__size-15">
														Some shop item
													</div>
											...
											<div class="flip__back lazyload" data-bg="{{asset('img/shop/shop-win-7.png')}}">
												<div class="flip-box__split-overlay brk-base-bg-gradient-10deg"></div>
												<div class="flip-box__split-content">
													<div class="pt-lg-30 pb-lg-30 pt-sm-20 pb-sm-20 pt-xs-40 pb-xs-40 pt-20 pb-20 position-relative z-index-5">
														<a href="#">
													...
													<div class="flip-box__split-actions">
														...
														<a href="{{asset('img/shop/shop-win-7.png')}}" class="add-search d-flex align-items-center justify-content-center fancybox">
															<i class="fas fa-search"></i>
														</a>
														<a href="#" class="add-wishlist d-flex align-items-center justify-content-center">
															<i class="fas fa-star"></i>
								...
								<div class="col-12 col-md-6 col-xl-4">
									<div class="flip-box text-center" data-brk-library="component__flip_box,component__elements,fancybox">
										<div class="flip flip_vertical flip-box__split">
											<div class="flip__front">
												<div class="flip-box__split-img lazyload" data-bg="{{asset('img/shop/shop-win-8.png')}}"></div>
												<div class="pt-30 pb-30 flip-box__split-info">
													<div class="font__family-montserrat font__weight-bold pl-20 pr-20 font__size-15">
														Some shop item
													</div>
											...
											<div class="flip__back lazyload" data-bg="{{asset('img/shop/shop-win-8.png')}}">
												<div class="flip-box__split-overlay brk-base-bg-gradient-10deg"></div>
												<div class="flip-box__split-content">
													<div class="pt-lg-30 pb-lg-30 pt-sm-20 pb-sm-20 pt-xs-40 pb-xs-40 pt-20 pb-20 position-relative z-index-5">
														<a href="#">
													...
													<div class="flip-box__split-actions">
														...
														<a href="{{asset('img/shop/shop-win-8.png')}}" class="add-search d-flex align-items-center justify-content-center fancybox">
															<i class="fas fa-search"></i>
														</a>
														<a href="#" class="add-wishlist d-flex align-items-center justify-content-center">
															<i class="fas fa-star"></i>
								...
								<div class="col-12 col-md-6 col-xl-4">
									<div class="flip-box text-center" data-brk-library="component__flip_box,component__elements,fancybox">
										<div class="flip flip_vertical flip-box__split">
											<div class="flip__front">
												<div class="flip-box__split-img lazyload" data-bg="{{asset('img/shop/shop-win-9.png')}}"></div>
												<div class="pt-30 pb-30 flip-box__split-info">
													<div class="font__family-montserrat font__weight-bold pl-20 pr-20 font__size-15">
														Some shop item
													</div>
											...
											<div class="flip__back lazyload" data-bg="{{asset('img/shop/shop-win-9.png')}}">
												<div class="flip-box__split-overlay brk-base-bg-gradient-10deg"></div>
												<div class="flip-box__split-content">
													<div class="pt-lg-30 pb-lg-30 pt-sm-20 pb-sm-20 pt-xs-40 pb-xs-40 pt-20 pb-20 position-relative z-index-5">
														<a href="#">
													...
													<div class="flip-box__split-actions">
														...
														<a href="{{asset('img/shop/shop-win-9.png')}}" class="add-search d-flex align-items-center justify-content-center fancybox">
															<i class="fas fa-search"></i>
														</a>
														<a href="#" class="add-wishlist d-flex align-items-center justify-content-center">
															<i class="fas fa-star"></i>
								...
								<div class="col-12 col-md-6 col-xl-4">
									<div class="flip-box text-center" data-brk-library="component__flip_box,component__elements,fancybox">
										<div class="flip flip_vertical flip-box__split">
											<div class="flip__front">
												<div class="flip-box__split-img lazyload" data-bg="{{asset('img/shop/shop-win-10.png')}}"></div>
												<div class="pt-30 pb-30 flip-box__split-info">
													<div class="font__family-montserrat font__weight-bold pl-20 pr-20 font__size-15">
														Some shop item
													</div>
											...
											<div class="flip__back lazyload" data-bg="{{asset('img/shop/shop-win-10.png')}}">
												<div class="flip-box__split-overlay brk-base-bg-gradient-10deg"></div>
												<div class="flip-box__split-content">
													<div class="pt-lg-30 pb-lg-30 pt-sm-20 pb-sm-20 pt-xs-40 pb-xs-40 pt-20 pb-20 position-relative z-index-5">
														<a href="#">
													...
													<div class="flip-box__split-actions">
														...
														<a href="{{asset('img/shop/shop-win-10.png')}}" class="add-search d-flex align-items-center justify-content-center fancybox">
															<i class="fas fa-search"></i>
														</a>
														<a href="#" class="add-wishlist d-flex align-items-center justify-content-center">
															<i class="fas fa-star"></i>
					...
					<div class="col-12 col-lg-4 col-xl-3 order-xs-1 order-lg-2">
						<div class="brs-sidebar brs-sidebar_right" data-brk-library="component__widgets">
							...
							<div class="brk-slider-cube" data-brk-library="component__widgets,slider__swiper">
								<div class="brk-slider-cube__overlay" style="height:35% !important; top: 21% !important;"></div>
