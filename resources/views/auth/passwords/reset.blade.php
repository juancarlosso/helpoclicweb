                            ...
                            <div class="panel panel-primary">
                                <div class="tab-menu-heading">
                                    <div class="tabs-menu1">
                                         <p><small>{{$nombre}} captura tu nuevo password y confírmalo</small></p>
                                    </div>
                                </div>                                
                                <form id="frm" method="POST" action="{{ route('password.update') }}">
                                   @csrf             
                                       ...
                                       <div class="tab-content">
                                           <div class="tab-pane active" id="tab5">
                                               <div class="wrap-input100 validate-input input-group" data-bs-validate="Valid email is required: ex@abc.xyz">
                                                   ...
                                                   <input class="input100 form-control @error('email') is-invalid @enderror" type="email" placeholder="Email" id="email" name="email" value="{{ $email }}" readonly placeholder="Email" required="required" >
                                                   @error('email')
                                               ...
                                               <div class="wrap-input100 validate-input input-group" id="Password-toggle">
                                                   ...
                                                   <input class="input100 form-control @error('password') is-invalid @enderror" type="password" placeholder="Password" name="password" value="{{ old('password') }}" placeholder="Password" required="required">
                                                   @error('password')
                                                       <span class="invalid-feedback" role="alert">
                                                           <strong>{{ $message }}</strong>
                                                       </span>
                                               ...
                                               <div class="wrap-input100 validate-input input-group" id="Password-toggle">
                                                   ...
                                                   <input class="input100 form-control @error('password-confirm') is-invalid @enderror" type="password" placeholder="Confirmar password" id="password_confirmation" name="password_confirmation" value="{{ old('password-confirmation') }}" placeholder="Password" required="required">
                                               ...
                                               <div class="container-login100-form-btn">
                                                   <button type="submit" class="login100-form-btn btn-primary">Actualizar</button>
                                               </div>
                                           </div>                                          
                                       </div>
                                   </div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Reset Password') }} reset!!!</div>
