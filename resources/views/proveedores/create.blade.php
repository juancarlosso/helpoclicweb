...
<div class="card">
	<div class="card-header">
		<h4 class="card-title">Datos del nuevo proveedor</h4>
	</div>
	<div class="card-body">
		<form class="form-horizontal" method="POST" action="{{route('proveedores.store')}}">
			...
			<div class=" row mb-4">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" id="razon_social" name="razon_social" placeholder="" value="{{old('razon_social')}}">
				</div>
			</div>
			<div class=" row mb-4">
				<label for="nombre_contacto" class="col-md-3 form-label">Nombre contacto</label>
				<div class="col-md-9">
					<input type="text" class="form-control" id="nombre_contacto" name="nombre_contacto" placeholder="" value="{{old('nombre_contacto')}}">
				</div>
			</div>
			<div class=" row mb-4">
				<label for="telefono_contacto" class="col-md-3 form-label">Teléfono contacto</label>
				<div class="col-md-9">
					<input type="text" class="form-control" id="telefono_contacto" name="telefono_contacto" placeholder="" value="{{old('telefono_contacto')}}">
				</div>
			</div>
			<div class=" row mb-4">
				<label for="email_contacto" class="col-md-3 form-label">Email contacto</label>
				<div class="col-md-9">
					<input type="email" class="form-control" id="email_contacto" name="email_contacto" placeholder="" value="{{old('email_contacto')}}">
				</div>
			</div>
