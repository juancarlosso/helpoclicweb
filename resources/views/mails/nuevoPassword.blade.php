                    ...
                    <table width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block"
                                ...
                                valign="top">
                                Hola {{ $datos->nombre }}: <br><br>A continuación tienes tus nuevos datos de acceso a la App.<br>
                                Una vez que hayas entrado, te recomendamos ampliamente cambiarlos dentro de la propia app ya que estos 
