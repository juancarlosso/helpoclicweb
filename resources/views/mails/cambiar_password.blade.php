                    ...
                    <table width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block"
                                ...
                                Hola {{ $datos->nombre }}: <br><br>Has solicitado cambiar tu password, si tu no has hecho esta solicitud, por favor ignora este mensaje. <br><br>
                                En caso de querer hacerlo,  debes presionar el siguiente bot&oacute;n.<br><br>
                        ...
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block" itemprop="handler" itemscope
                                ...
                                style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                valign="top">
                                <a href="{{ $datos->enlace }}" class="btn-primary" itemprop="url"
                                ...
                                <small>
                                <i>
                                Si el bot&oacute;n no funciona, copia y pega el siguiente enlace en tu navegador.<br>
                                {{ $datos->enlace }}
                                </i>
                                </small>                                    
